...
<body>
    <h1> What factors influence total compensation, salary and yearly bonuses at BananaByte? </h1>
        <p> This python project explores a fictitious company BananaByte's entry level, mid-level, management level, and executive level staff members' total compensation, salary and yearly bonuses. </p>
    ...
    <b> <p> Tools & Methods:</b> Python, NumPy, Pandas, SciPy Stats, Seaborn and ScikitLearn in a Python Notebook for analysis and a PowerBI Dashboard for the final report </p>
